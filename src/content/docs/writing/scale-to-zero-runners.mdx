...
Real production usage bursted into the hundreds of jobs concurrently during deploy windows, then sat near-idle overnight. The "always-on" baseline would have had to size for the peak — multiplying the cost gap further.
</Aside>
